...
// semi: semi-product names (1 each consumed per craft)
const RECIPES = {
  // ===== Malaysia =====
...
function purchaseApply_(body) {
  ...
  // Build product pool: country + level
...
function repairProductNames() {
  ...
  // Build a normalized lookup from RECIPES keys
